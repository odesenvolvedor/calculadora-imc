        ...
        <div id="savedBMI" class="savedBMI" data-getBDataURL="<?php echo plugins_url( 'bmibmr_get.php' , __FILE__ ); ?>" data-userid="<?php echo get_current_user_id(); ?>">
            ...
            foreach ($savedRows as $row) {
                ...
                if ( isset($fromData_arr['bmibmr']) && $fromData_arr['bmibmr'] == 'bmr') {
                    ...
                    $calc_choice = '<strong>BMR : '.$BMR.', </strong> Requisição calórica diária estimadas : <strong>'.$daily_burn.'</strong><hr>';
                }
                else {
                    ...
                    <div class="alert alert-warning " role="alert">
                        <div class="uListbmibmr">
                            <ul>
                                ...
                                <li>Salvo em: <span><?php echo date("F j, Y, g:i a", strtotime($row->timeof)); ?></span></li>
                                ...
                                <li>Nota: <span><?php echo $fromData_arr['descriptionB']; ?></span></li>
                            </ul>
                        </div>
                    </div>  </div>
            <?php
